...
- **A real REST surface**: pagination, field filtering, substring search,
  and sorting, `GET`/`POST`/`PUT`/`PATCH`/`DELETE`, without writing a Route Handler or
  an MSW handler by hand for every entity.
